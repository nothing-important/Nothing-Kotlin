...
package com.example.administrator.nothing_kotlin.cardview;
...
public class CardView extends FrameLayout {
    ...
    private ColorStateList shadowColorStart;
    private ColorStateList shadowColorEnd;
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        shadowColorStart = a.getColorStateList(R.styleable.CardView_cardShadowColorStart);
        shadowColorEnd = a.getColorStateList(R.styleable.CardView_cardShadowColorEnd);
    ...
    public void setCardShadowStartColor(@Nullable int color) {
        IMPL.setShadowStartColor(mCardViewDelegate, ColorStateList.valueOf(color));
    }

...
public class RoundImageView extends ImageView {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        bitmapRadius = (int) typedArray.getDimension(R.styleable.RoundImageView_roundborderRadius , ScreenU.Companion.dp2px(context , DEFAULT_RADIUS));
    ...
    public void setBitmapType(BitmapType bitmapType){
        if (bitmapType == BitmapType.ROUND){
            this.bitmapType = 1;
        }else {
            this.bitmapType = 0;
        }
    ...
    public void setRoundRadius(int values){
        bitmapRadius = values;
    }
